...
- [责任链模式](./haha-design-pattern/行为型模式/责任链模式（职责链模式）详解.md)
- [状态模式](./haha-design-pattern/行为型模式/状态模式（详解版）.md)
- [观察者模式](./haha-design-pattern/行为型模式/观察者模式（Observer模式）详解.md)
- [中介者模式](./haha-design-pattern/行为型模式/中介者模式（详解版）.md)
- [迭代器模式](./haha-design-pattern/行为型模式/迭代器模式（详解版）.md)
- [访问者模式](./haha-design-pattern/行为型模式/访问者模式（Visitor模式）详解.md)
- [备忘录模式](./haha-design-pattern/行为型模式/备忘录模式（详解版）.md)
- [解释器模式](./haha-design-pattern/行为型模式/解释器模式（详解版）.md)
