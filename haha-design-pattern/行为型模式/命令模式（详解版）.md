...
<br>
![avatar](http://c.biancheng.net/uploads/allimg/181116/3-1Q1161134341E.gif)
<br>
程序代码如下：
```java
package command;
...
```
程序的运行结果如图 2 所示。<br>
![avatar](http://c.biancheng.net/uploads/allimg/181116/3-1Q11611350Q06.jpg)
<br>
# 命令模式的应用场景
...
<br>
![avatar](http://c.biancheng.net/uploads/allimg/181116/3-1Q1161135322R.gif)
<br>
程序代码如下：
```java
package command;
