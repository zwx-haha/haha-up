...
## 3) 语法树
语法树是句子结构的一种树型表示，它代表了句子的推导结果，它有利于理解句子语法结构的层次。图 1 所示是“我是大学生”的语法树。<br>
![avatar](http://c.biancheng.net/uploads/allimg/181119/3-1Q119150550114.gif)
<br>
...
解释器模式的结构图如图 2 所示。<br>
![avatar](http://c.biancheng.net/uploads/allimg/181119/3-1Q119150626422.gif)
<br>
## 2. 模式的实现
...
![avatar](http://c.biancheng.net/uploads/allimg/181119/3-1Q119150Q6401.gif)
<br>
程序代码如下：
```java
package net.biancheng.c.interpreter;
